...
const cache = await mkdtemp(path.join(os.tmpdir(), "lookout-pack-"));
...
try {
  ...
  const requiredFiles = [
    ...
    "dist/src/index.js",
    "dist/src/index.d.ts",
    "dist/src/check-runner.js",
    "dist/src/check-runner.d.ts",
    "dist/src/registry.js",
    "dist/src/registry.d.ts",
    "dist/src/cli.js",
    "dist/src/cli.d.ts",
  ];
  ...
  console.log(`Lookout package contents check passed: ${files.length} files.`);
} finally {
